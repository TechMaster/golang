...
import (
	...
	vn_translations "demovalidator/vn"
...
func main() {
	...
	vn_translations.RegisterDefaultTranslations(validate, trans)
...
func translateOverride(trans ut.Translator) {
	...
	validate.RegisterTranslation("required", trans, func(ut ut.Translator) error {
		return ut.Add("required", "{0} phải có giá trị!", true) // see universal-translator for details
